...
tap_dance_action_t tap_dance_actions[] = {[TD_SUPER_CAPS] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, super_caps_finished, super_caps_reset), [TD_PRODUCTIVITY] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, productivity_finished, productivity_reset), [TD_ENCODER] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, encoder_td_finished, encoder_td_reset)};
#endif
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, LEFTOFENC, TD(TD_ENCODER), KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, BELOWENC, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS, KC_PGUP, TD(TD_SUPER_CAPS), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, KC_PGDN, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_END, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, MO(_FN1), TD(TD_PRODUCTIVITY), KC_LEFT, KC_DOWN, KC_RGHT),
 ...
 */
...
#ifdef GAME_ENABLE
    [_FN1] = LAYOUT(EE_CLR, KC_MYCM, KC_WHOM, KC_CALC, KC_MSEL, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_VOLD, KC_VOLU, KC_PSCR, KC_SCRL, KC_PAUS, KC_SLEP, PRNCONF, TG_CAPS, TG_PAD, TG_ESC, TG_DEL, TG_TDCAP, TG_ENC, TG_INS, TG_SPCMOD, TG_AUTOCR, _______, RGB_TOD, RGB_TOI, _______, RM_TOGG, _______, RM_SATD, RM_VALU, RM_SATU, NK_TOGG, _______, YAHOO, _______, _______, OUTLOOK, TG(_GAME), SWAP_L, SWAP_R, QK_BOOT, KC_HOME, KC_CAPS, RM_HUED, RM_VALD, RM_HUEU, _______, GMAIL, HOTMAIL, _______, _______, LOCKPC, _______, _______, _______, KC_END, _______, RGB_NITE, _______, _______, _______, QK_BOOT, KC_NUM, _______, _______, DOTCOM, KC_CAD, _______, RM_NEXT, _______, _______, WINLOCK, _______, _______, _______, _______, _______, RM_SPDD, RM_PREV, RM_SPDU),

    [_GAME] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),

#else
    [_FN1] = LAYOUT(EE_CLR, KC_MYCM, KC_WHOM, KC_CALC, KC_MSEL, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_VOLD, KC_VOLU, KC_PSCR, KC_SCRL, KC_PAUS, KC_SLEP, PRNCONF, TG_CAPS, TG_PAD, TG_ESC, TG_DEL, TG_TDCAP, TG_ENC, TG_INS, TG_SPCMOD, TG_AUTOCR, _______, RGB_TOD, RGB_TOI, _______, RM_TOGG, _______, RM_SATD, RM_VALU, RM_SATU, NK_TOGG, _______, YAHOO, _______, _______, OUTLOOK, KC_PAUS, SWAP_L, SWAP_R, QK_BOOT, KC_HOME, KC_CAPS, RM_HUED, RM_VALD, RM_HUEU, _______, GMAIL, HOTMAIL, _______, _______, LOCKPC, _______, _______, _______, KC_END, _______, RGB_NITE, _______, _______, _______, QK_BOOT, KC_NUM, _______, _______, DOTCOM, KC_CAD, _______, RM_NEXT, _______, _______, WINLOCK, _______, _______, _______, _______, _______, RM_SPDD, RM_PREV, RM_SPDU),
#endif // GAME_ENABLE
    ...
    [_NUMPADMOUSE] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_P1, KC_P2, KC_P3, KC_P4, KC_P5, KC_P6, KC_P7, KC_P8, KC_P9, KC_P0, KC_PMNS, KC_PPLS, _______, _______, _______, KC_PGUP, KC_UP, KC_PGDN, KC_NO, KC_NO, KC_NO, KC_P4, KC_P5, KC_P6, KC_PPLS, _______, _______, _______, MS_WHLU, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_P1, KC_P2, KC_P3, KC_PAST, _______, KC_PENT, MS_WHLD, _______, KC_NO, _______, _______, _______, _______, _______, KC_P0, KC_00, KC_PDOT, KC_PSLS, MS_BTN1, MS_UP, MS_BTN2, _______, _______, _______, KC_PENT, _______, _______, MS_BTN3, MS_LEFT, MS_DOWN, MS_RGHT),

    [_MOUSEKEY] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MS_WHLU, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MS_WHLD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MS_BTN1, MS_UP, MS_BTN2, _______, _______, _______, _______, _______, _______, MS_BTN3, MS_LEFT, MS_DOWN, MS_RGHT),

#ifdef COLEMAK_LAYER_ENABLE
    [_COLEMAK] = LAYOUT(_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, _______, KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, _______, _______, KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_LBRC, KC_RBRC, KC_BSLS, KC_PGUP, _______, KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O, KC_QUOT, KC_ENT, KC_PGDN, _______, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_END, _______, _______, _______, KC_SPC, KC_RALT, _______, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    ...
    } else if (mods_state & MOD_BIT(KC_RALT)) { // if holding Right Alt, change rgb hue/colour
